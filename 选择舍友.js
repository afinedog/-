...
$("div.img-container").click(function(){
    if ($(this).find("img").attr("alt") == "唐妞")
        ...
        roommate = new Roommate(
            // 开场独白
            ["全民制作人们大家好，我是练习时长两年半的个人练习生蔡徐坤","喜欢唱、跳、rap、篮球。","music！","只因你太美！baby","只因你实在是太美！baby","迎面走来的你让我如此蠢蠢欲动","这种感觉我从未有","Cause I got a crush on you who you", "你是，我的，我是，你的，谁",],
            // 交互语言
        ...
        roommate = new Roommate(
            ...
            //交互语言
            ["到底来没来？如来","当然你们受了西方的操作体系，没有精子卵子的结合，那是一定是不会怀孕的。那是你的操作系统，那你要问我的操作系统，我觉得一切皆有可能","我去了以后，我坐在他家的门堂正中。他家的牌位，天 地 君 亲 师。我在那里一坐，他的爷爷奶奶先给我磕头，爹妈给我磕，一家人全磕完了，小孩恭恭敬敬给我磕大头。","多少年轻人加一点班，领导让他加点班，抱怨。你知道吗领导让谁加班不行啊，你以为在中国这个环境里边还缺加班的人吗？"]
        )
